...
<html>
  ...
  <link href="css/web_style.css" rel="stylesheet">
    ...
    <header>
        ...
        <img src="assets/img/logo.png" width="8%" height="8%" style="float: left; magin-top:20px;"> 
    <b> FEDERAL UNIVERSITY, DUTSINMA KATSINA STATE NIGERIA </b> <br>
    <b style="color: white; font-size: 16px;">DEPARTMENT OF EDUCATIONAL ADMINISTRATION AND PLANNING</b>
    ...
    <div>
         <nav id="navbar" class="navbar">
            ...
            <!-- <ul class="nav nav-pills"> rgb(175, 124, 28) nav bar bg-->
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="issues.php">CURRENT ISSUES</a>
                </li>
                <li class="nav-item">
