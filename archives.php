...
<html>
  ...
  <link href="css/web_style.css" rel="stylesheet">
       ...
       <!-- <center> <h1 style="font-size: 20px;"><b>ARCHIVED SUBMISSIONS</b></h1></center><br>
...
<center> <h1 style="font-size: 20px;"><b>ARCHIVE SUBMITTED ARTICLES</b></h1></center><br>
        <p align="justify">Below is the sample of the archives submited articles </p>
            <div>
    <?php  
           $plimited = 03;
...
$total= ceil($rowcount/$plimited);
      for($rs=1; $rs<=$total; $rs++):
        ...
        <li class="page-item">
            <a class="page-link" href="archives.php?page=<?php echo $rs; ?> "> <?php echo $rs ?> </a></li>
        <li class="page-item">
